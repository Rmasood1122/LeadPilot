"""Migration 0047 (Feature A7) must create exactly the table the model
...
def test_the_revision_follows_0046():
    module = _load(MIGRATION)
    assert module.revision == "0047_sequence_reviews"
    assert module.down_revision == "0046_share_links"

"""Migration 0051 (Feature 8) must create exactly the table the model declares
...
MIGRATION = "0051_compliance_rules.py"
...
def test_the_revision_follows_0050():
    module = _load(MIGRATION)
    assert module.revision == "0051_compliance_rules"
    assert module.down_revision == "0050_benchmarks"
